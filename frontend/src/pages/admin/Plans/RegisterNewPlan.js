...
export default function RegisterNewPlan(){
    const handleSubmit = async (e) => {
        ...
        const instituteplaylist_count = document.querySelector("#institute_playlist_count").value;
        const teacher_count = document.querySelector("#teacher_count").value;
        console.log(plan_name,playlist_6am,instituteplaylist_count,teacher_count,selfVoiceStatus);
